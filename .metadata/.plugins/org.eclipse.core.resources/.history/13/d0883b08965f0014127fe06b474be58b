...
//							int cntIntersectsOutsideCircle = 0;
							if(intersect != null){
								//if it's inside the circle cntIntersectsInCircle++;
								if(intersect.dist(cCenterP) < r)
									cntIntersectsInCircle++;
//								else
//									cntIntersectsOutsideCircle++;
								//else it's outside the circle cntIntersectsOutsideCircle++;
							}
							//if cntIntersectsInCircle == 0; then pieces++;
							//else if cntIntersectsInCircle > 1 then pieces+=2; intersectsInCircle--; pieces+=interSectsInCircle
							//else pieces+=2;
//							System.out.println("a line's cntIntersectsInCircle: "+cntIntersectsInCircle);
						}
//						System.out.println("pieces count: "+pieces);
					}
